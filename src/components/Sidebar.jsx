...
export default function Sidebar({ active = "today" }) {
  ...
  return (
    <>
      <div
        className={`w-full h-full md:visible top-0 ${
          sidebarOpen ? "md:w-auto" : "w-0 invisible"
      ...
      />
      <div
        className={`bg-grayLight dark:bg-[#242424] left-0 top-0 md:top-[48px] ${
          sidebarOpen ? "" : "-translate-x-full invisible w-0"
      ...
      >
        ...
        <Link to="/app">
          <div
            className={`flex py-2 hover:text-primary transition-colors duration-300 ${
              active == "today" ? "text-primary" : "text-gray dark:text-white"
            }`}
          >
        ...
        <Link to="/app/upcoming">
          <div
            className={`flex py-2 hover:text-primary transition-colors duration-300 ${
              active == "future" ? "text-primary" : "text-gray dark:text-white"
            }`}
          >
