...
const TodoList = ({ id, task, description, completed }) => {
  ...
  return (
    <div className="flex mb-2">
      ...
      <div className="group border border-graySoft dark:border-zinc-500 dark:bg-zinc-700 py-2 px-4 rounded-md w-full flex justify-between">
        <div>
          <h1 className="font-bold">{task}</h1>
          <p className="text-gray dark:text-graySoft">{description}</p>
        </div>
        <div
          ref={dropdownRef}
